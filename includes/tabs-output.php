...
<div class='azrcrv-donate'>
	<?php
		printf( esc_html__( 'Support %s', 'azrcrv-cf' ), esc_html( DEVELOPER_NAME ) );
	?>
	...
	<span>
		<?php
		esc_html_e( 'You can help support the development of our free plugins by donating a small amount of money.', 'azrcrv-cf' );
		?>
	</span>
</div>
