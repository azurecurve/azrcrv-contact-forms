 ...
 * @since 1.0.0
 */
if ( ! function_exists( 'azrcrv_create_plugin_menu_cf' ) ) {
	function azrcrv_create_plugin_menu_cf() {
		azrcrv_populate_plugin_menu_cf();
	}
}
 ...
 * @since 1.0.0
 */
if ( ! function_exists( 'azrcrv_populate_plugin_menu_cf' ) ) {
	function azrcrv_populate_plugin_menu_cf() {
